...
- `stock-system-backend/` – Spring Boot Java backend (includes Finnhub integration)
...
**Environment:** Set `FINNHUB_API_KEY` for market data.
...
- `make logs` – View logs
- `make deploy-backend` – Build/push backend to registry
