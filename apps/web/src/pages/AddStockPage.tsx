      ...
      <div className="card">
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <input value={symbol} onChange={e => setSymbol(e.target.value)} placeholder="e.g. TSLA, AAPL" required style={{ margin: "0" }} />
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label style={{ fontSize: "0.9rem", color: "var(--muted)", marginBottom: "6px", fontWeight: "500" }}>
              Company Name
            </label>
            <input value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Tesla Inc." required style={{ margin: "0" }} />
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label style={{ fontSize: "0.9rem", color: "var(--muted)", marginBottom: "6px", fontWeight: "500" }}>
              Price ($)
            </label>
            <input type="number" value={price} onChange={e => setPrice(Number(e.target.value))} placeholder="0.00" required style={{ margin: "0" }} />
          </div>
